...
## Poll Jobs
You must create 4 jobs that will be linked together (2 by 2) to create 2 pipelines that you will be created in next steps.
- DB_apply_data_model_uuid_table
- DB_rollback_data_model_uuid_table
